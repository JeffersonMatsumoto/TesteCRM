...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_TESTE_DROPDOWN">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_TESTE_DROPDOWN' module='Contacts'}{/capture}
{$label|strip_semicolon}:

{/minify}
</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="dynamicenum" field="teste_dropdown_c"  >
...
<select name="{$fields.teste_dropdown_c.name}"
id="{$fields.teste_dropdown_c.name}"
title=''           
>
{if isset($fields.teste_dropdown_c.value) && $fields.teste_dropdown_c.value != ''}
{html_options options=$fields.teste_dropdown_c.options selected=$fields.teste_dropdown_c.value}
{else}
{html_options options=$fields.teste_dropdown_c.options selected=$fields.teste_dropdown_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.teste_dropdown_c.options }
{capture name="field_val"}{$fields.teste_dropdown_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.teste_dropdown_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.teste_dropdown_c.name}"
id="{$fields.teste_dropdown_c.name}"
title=''          
>
{if isset($fields.teste_dropdown_c.value) && $fields.teste_dropdown_c.value != ''}
...
<input
id="{$fields.teste_dropdown_c.name}-input"
name="{$fields.teste_dropdown_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.teste_dropdown_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.teste_dropdown_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.teste_dropdown_c.name}-input', '{$fields.teste_dropdown_c.name}');sync_{$fields.teste_dropdown_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
...
{literal}
(function (){
    var selectElem = document.getElementById("{/literal}{$fields.teste_dropdown_c.name}{literal}");
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
    ...
    SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.teste_dropdown_c.name}-input');
    SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.teste_dropdown_c.name}-image');
    SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.teste_dropdown_c.name}');
    ...
    //global variable
    sync_{/literal}{$fields.teste_dropdown_c.name}{literal} = function(){
        SyncToHidden();
    }
    function syncFromHiddenToWidget(){
        ...
        for (i=0;i<selectElem.options.length;i++){
            ...
            if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.teste_dropdown_c.name}-input{literal}'))
                SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
        }
    }

    YAHOO.util.Event.onAvailable("{/literal}{$fields.teste_dropdown_c.name}{literal}", syncFromHiddenToWidget);
    {/literal}
...
<script type="text/javascript">
    ...
    addLoadEvent(function(){literal}{loadDynamicEnum({/literal}"","{$fields.teste_dropdown_c.name}"{literal})}{/literal});
    if (SUGAR.ajaxUI && SUGAR.ajaxUI.hist_loaded) {literal}{loadDynamicEnum({/literal}"","{$fields.teste_dropdown_c.name}"{literal})}{/literal}
</script>
</div>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_DROPDOWN_TESTE_DYNAMIC">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DROPDOWN_TESTE_DYNAMIC' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="dropdown_teste_dynamic_c"  >
{counter name="panelFieldCount" print=false}

{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.dropdown_teste_dynamic_c.name}" 
id="{$fields.dropdown_teste_dynamic_c.name}" 
title=''       
>
{if isset($fields.dropdown_teste_dynamic_c.value) && $fields.dropdown_teste_dynamic_c.value != ''}
{html_options options=$fields.dropdown_teste_dynamic_c.options selected=$fields.dropdown_teste_dynamic_c.value}
{else}
{html_options options=$fields.dropdown_teste_dynamic_c.options selected=$fields.dropdown_teste_dynamic_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.dropdown_teste_dynamic_c.options }
{capture name="field_val"}{$fields.dropdown_teste_dynamic_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.dropdown_teste_dynamic_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.dropdown_teste_dynamic_c.name}" 
id="{$fields.dropdown_teste_dynamic_c.name}" 
title=''          
>
{if isset($fields.dropdown_teste_dynamic_c.value) && $fields.dropdown_teste_dynamic_c.value != ''}
...
<input
id="{$fields.dropdown_teste_dynamic_c.name}-input"
name="{$fields.dropdown_teste_dynamic_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.dropdown_teste_dynamic_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.dropdown_teste_dynamic_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.dropdown_teste_dynamic_c.name}-input', '{$fields.dropdown_teste_dynamic_c.name}');sync_{$fields.dropdown_teste_dynamic_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.dropdown_teste_dynamic_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.dropdown_teste_dynamic_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.dropdown_teste_dynamic_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.dropdown_teste_dynamic_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.dropdown_teste_dynamic_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.dropdown_teste_dynamic_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.dropdown_teste_dynamic_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
<div class="panel-body panel-collapse collapse in panelContainer" id="detailpanel_0" data-id="LBL_CONTACT_INFORMATION">
<div class="tab-content">
<!-- tab_panel_content.tpl -->
<div class="row edit-view-row">
...
addToValidate('EditView', 'date_entered_date', 'date', false,'Data de Criação' );
...
addToValidate('EditView', 'dropdown_teste_dynamic_c', 'enum', true,'{/literal}{sugar_translate label='LBL_DROPDOWN_TESTE_DYNAMIC' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'teste_dropdown_c', 'dynamicenum', false,'{/literal}{sugar_translate label='LBL_TESTE_DROPDOWN' module='Contacts' for_js=true}{literal}' );
...
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_account_name']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id","billing_address_street","billing_address_city","billing_address_state","billing_address_postalcode","billing_address_country","phone_office"],"populate_list":["EditView_account_name","account_id","primary_address_street","primary_address_city","primary_address_state","primary_address_postalcode","primary_address_country","phone_work"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id"],"order":"name","limit":"30","no_match_text":"Nenhum Resultado"};sqs_objects['EditView_assigned_user_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nenhum Resultado"};sqs_objects['EditView_report_to_name']={"form":"EditView","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["report_to_name","reports_to_id","reports_to_id","reports_to_id"],"required_list":["reports_to_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"Nenhum Resultado"};sqs_objects['EditView_campaign_name']={"form":"EditView","method":"query","modules":["Campaigns"],"group":"or","field_list":["name","id"],"populate_list":["campaign_id","campaign_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["campaign_id"],"order":"name","limit":"30","no_match_text":"Nenhum Resultado"};</script>{/literal}

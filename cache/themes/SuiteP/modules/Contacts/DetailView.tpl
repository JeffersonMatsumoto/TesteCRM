...
{sugar_translate label='LBL_DETAILVIEW_PANEL1' module='Contacts'}
</div>
</a>
</div>
...
{if !$fields.teste_dropdown_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.teste_dropdown_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.teste_dropdown_c.name}" value="{ $fields.teste_dropdown_c.options }">
{ $fields.teste_dropdown_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.teste_dropdown_c.name}" value="{ $fields.teste_dropdown_c.value }">
{ $fields.teste_dropdown_c.options[$fields.teste_dropdown_c.value]}
{/if}
{/if}
...
{if !$fields.dropdown_teste_dynamic_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.dropdown_teste_dynamic_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.dropdown_teste_dynamic_c.name}" value="{ $fields.dropdown_teste_dynamic_c.options }">
{ $fields.dropdown_teste_dynamic_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.dropdown_teste_dynamic_c.name}" value="{ $fields.dropdown_teste_dynamic_c.value }">
{ $fields.dropdown_teste_dynamic_c.options[$fields.dropdown_teste_dynamic_c.value]}
{/if}
{/if}

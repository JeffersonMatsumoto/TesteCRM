...
{sugar_translate label='LBL_DETAILVIEW_PANEL1' module='Accounts'}
</div>
</a>
</div>
...
{/if} 
<span class="sugar_field" id="{$fields.teste_c.name}">{$fields.teste_c.value}</span>
{/if}

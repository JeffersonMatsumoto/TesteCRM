<?php /* Smarty version 2.6.31, created on 2020-09-13 21:51:33
         compiled from cache/themes/SuiteP/modules/Contacts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 46, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 55, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 145, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 223, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 367, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 138, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 475, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 475, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 475, false),array('modifier', 'strip_tags', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 486, false),)), $this); ?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DETAILVIEW_PANEL1','module' => 'Contacts'), $this);?>

</div>
</a>
</div>
<div class="panel-body panel-collapse collapse panelContainer" id="top-panel-0"  data-id="LBL_DETAILVIEW_PANEL1">
<div class="tab-content">
<!-- TAB CONTENT -->
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="dynamicenum" field="teste_dropdown_c" >

<?php if (! $this->_tpl_vars['fields']['teste_dropdown_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['teste_dropdown_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['options'][$this->_tpl_vars['fields']['teste_dropdown_c']['value']]; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="dropdown_teste_dynamic_c" >

<?php if (! $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['options'][$this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['value']]; ?>

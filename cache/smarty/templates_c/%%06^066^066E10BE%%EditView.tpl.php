...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TESTE_DROPDOWN','module' => 'Contacts'), $this);?>
...
<select name="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
"
id="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
"
title=''           
>
<?php if (isset ( $this->_tpl_vars['fields']['teste_dropdown_c']['value'] ) && $this->_tpl_vars['fields']['teste_dropdown_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['teste_dropdown_c']['options'],'selected' => $this->_tpl_vars['fields']['teste_dropdown_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['teste_dropdown_c']['options'],'selected' => $this->_tpl_vars['fields']['teste_dropdown_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['teste_dropdown_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
"
id="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
"
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
-input');
    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
-image');
    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['teste_dropdown_c']['name']; ?>
');
...
<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DROPDOWN_TESTE_DYNAMIC','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['value'] ) && $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['options'],'selected' => $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['options'],'selected' => $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<?php echo '
<script>
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['dropdown_teste_dynamic_c']['name']; ?>
');
...
<?php echo '\' );
addToValidate(\'EditView\', \'dropdown_teste_dynamic_c\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DROPDOWN_TESTE_DYNAMIC','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'teste_dropdown_c\', \'dynamicenum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TESTE_DROPDOWN','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );

...
$mod_strings = array (
  ...
  'LBL_REPLY_ASSIGNING_BEHAVIOR' => 'Atribuir respostas a',
  'LBL_REPLY_ASSIGNING_BEHAVIOR_HELP' => 'Quando um e-mail de entrada é uma resposta a um email enviado do SuiteCRM, escolha opção para quem a resposta será atribuída:<br><br><b>Não fazer nada:</b> Comportamento padrão. O e-mail não será atribuído a ninguém.<br><br><b>Responder ao proprietário do e-mail:</b> o e-mail é atribuído para o proprietário da resposta ao e-mail, ou o último e-mail enviado do SuiteCRM no segmento. <br><br><b>Proprietário do registro associado:</b> o e-mail é atribuído ao proprietário do registro que respondeu ao e-mail, ou ao último e-mail enviado do SuiteCRM no segmento, com que está relacionado.',
  'LBL_CREATE_CONTACT' => 'Criar contato a partir do e-mail',
  'LBL_CREATE_CONTACT_HELP' => 'Selecione para criar automaticamente contatos no SuiteCRM a partir dos emails recebidos.',
  'LBL_CONTACT_DEFAULT_LANGUAGE' => 'Idioma padrão do contato',
  'LBL_FILL_CONTACT_NAME' => 'Preencher o nome do contato',
  'LBL_FILL_CONTACT_NAME_HELP' => 'Selecione para preencher automaticamente o primeiro nome e sobrenome do novo contato, criado a partir dos emails recebidos.',
  'LBL_CONTACT_DEFAULT_SOURCE' => 'Nova fonte de contato',
  'LBL_NEW_CASE_STATUS' => 'Status para a ocorrência criada',
  'LBL_NEW_CASE_PRIORITY' => 'Prioridade para a ocorrência criada',
  'LBL_NEW_CASE_TYPE' => 'Tipo para a ocorrência criada',
);
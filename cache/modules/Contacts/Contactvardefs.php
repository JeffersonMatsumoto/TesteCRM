<?php 
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    'dropdown_teste_dynamic_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Dropdown Dinâmico',
      'required' => true,
      'source' => 'custom_fields',
      'name' => 'dropdown_teste_dynamic_c',
      'vname' => 'LBL_DROPDOWN_TESTE_DYNAMIC',
      'type' => 'enum',
      'massupdate' => 0,
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'dropdown_teste_dynamic_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactsdropdown_teste_dynamic_c',
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Dropdown Teste',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'teste_dropdown_c',
      'vname' => 'LBL_TESTE_DROPDOWN',
      'type' => 'dynamicenum',
      'massupdate' => 0,
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'teste_dropdown_list',
      'studio' => 'visible',
      'dbType' => 'enum',
      'parentenum' => '',
      'id' => 'Contactsteste_dropdown_c',
      'custom_module' => 'Contacts',
    ),
  ),
  'indices' => 

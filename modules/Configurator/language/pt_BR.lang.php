...
$mod_strings = array(
    ...
    'SUITEPDF_BASIC_SETTINGS' => 'Propriedades do Documento',
    'SUITEPDF_ADVANCED_SETTINGS' => 'Definições Avançadas',
    'SUITEPDF_LOGO_SETTINGS' => 'Imagens',
    ...
    'PDF_NEW_HEADER_LOGO_INFO' => 'O arquivo pode ser .jpg ou .png (para EZPDF use apenas .jpg )<BR>O tamanho recomendado é 867x60 px.',
...
// Wizard
    ...
    // Google auth PR 6146
    'LBL_GOOGLE_AUTH_TITLE' => 'Autenticação do Google',
    'LBL_GOOGLE_AUTH_JSON' => 'Arquivo JSON',
    'LBL_GOOGLE_AUTH_JSON_HELP' => 'Envie o arquivo JSON que você baixou do console do Google Developers.',
